...
const editCloseButton = document.querySelector('.edit__close-button');
...
const formElementEdit = document.querySelector('.edit__form');
const formElementAdd = document.querySelector('.add__form');
