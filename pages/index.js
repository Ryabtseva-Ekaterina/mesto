...
const editCloseButton = document.querySelector('.edit__popup-close-button');
const addCloseButton = document.querySelector('.add__popup-close-button');
const zoomCloseButton = document.querySelector('.zoom-popup__close-button');
const formElementEdit = document.querySelector('.edit__popup-form');
const formElementAdd = document.querySelector('.add__popup-form');
